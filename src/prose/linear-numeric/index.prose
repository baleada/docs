...
Also, feel free to peruse the [full default config](/docs/tailwind-linear/default-config) returned by the `linearNumeric` function if you're curious about specific underlying values.
