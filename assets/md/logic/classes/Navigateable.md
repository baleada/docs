...
| `setLocation(location)` | Function | Passes the new `location` to the `navigate` method in order to navigate to a specific item | The new `location` (Number) | The `Navigateable` instance |
